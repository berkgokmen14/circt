//===- SSPInterfaces.h - Declare SSP interfaces ------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares the operation interfaces for the SSP Dialect.
//
//===----------------------------------------------------------------------===//

#ifndef CIRCT_DIALECT_SSP_INTERFACES_H
#define CIRCT_DIALECT_SSP_INTERFACES_H
...
#include "circt/Dialect/SSP/SSPInterfaces.h.inc"
#endif // CIRCT_DIALECT_SSP_INTERFACES_H
